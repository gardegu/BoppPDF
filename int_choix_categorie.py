...
class IntChoixCategorie(Screen):
    """ 
    Classe du menu de choix de la catégorie pour les intervenants
    """
    def __init__(self, **kwargs):
        """
        Visuel du menu de choix de la catégorie pour les intervenants
        """
        super(IntChoixCategorie, self).__init__(**kwargs)
    ...
    def go_to_local_machine(self, instance):
        """
        Passe au menu local machine des intervenants
        Args:
    ...
    def go_to_treuils(self, instance):
        """
        Passe au menu treuils des intervenants
        Args:
          instance: arg de binding
    ...
    def go_to_cabestan(self, instance):
        """
        Passe au menu cabestan des intervenants
        Args:
          instance: arg de binding
    ...
    def go_to_appareil_gouverne(self, instance):
        """
        Passe au menu appareil à gouverner des intervenants
        Args:
          instance: arg de binding
    ...
    def go_to_modif_carac_affaire(self, instance):
        """
        Passe au menu de modification des caractéristiques affaires
        Args:
          instance: arg de binding
    ...
    def go_to_closure(self, instance):
        """
        Passe au menu de validation de l'affaire pour les intervenants
        Args:
          instance: arg de binding
