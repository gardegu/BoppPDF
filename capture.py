...
class Capture(Screen):
    """ 
    Classe du menu Capture du BE (plus utilisé)
    """
    def __init__(self, **kwargs):
        """
        Visuel du menu Capture
        """
    ...
    def take_picture(self, instance):
        """
        Enregistre le contenu du widget Camera sous forme d'image PNG
        Args:
    ...
    def link_data(self):
        """ 
        Met à jour les données de la galerie photo à partir des données entrées par l'utilisateur
        """
        app_data = AppData()
    ...
    def on_enter(self, *args):
        """
        Allume la caméra à l'entrée dans l'écran
        Args:
    ...
    def on_leave(self, *args):
        """
        Eteint la caméra à la sortie de l'écran
        Args:
          *args: arguments nécessaires pour le binding de la fonction
    ...
    def show_popup(self, message):
        """
        Permet de faire apparaître une popup avec un message
        Args:
