...
class LocalMachine(Screen):
    ...
    def link_data(self):
        ...
        app_data.schema_synoptique = self.schema_synoptique.text 
        app_data.schema_electrique = self.schema_electrique.text 
        app_data.schema_bornier = self.schema_bornier.text 
        app_data.schema_cablage = self.schema_cablage.text 
        app_data.releves_rincages_circuits = self.releves_rincages_circuits.text 
        app_data.as_niveau_bas_NB1 = self.as_niveau_bas_NB1.text 
        app_data.as_temperature_haute_TH1 = self.as_temperature_haute_TH1.text 
        app_data.as_controle_ARU = self.as_controle_ARU.text 
        app_data.as_alarme_hydraulique_voyant_defaut = self.as_alarme_hydraulique_voyant_defaut.text 
        app_data.pompe_principale_45_100_verif_plein_huile = self.pompe_principale_45_100_verif_plein_huile.text 
        app_data.pompe_principale_45_100_sens_rotation = self.pompe_principale_45_100_sens_rotation.text 
        app_data.pompe_principale_45_100_embrayage_pompe = self.pompe_principale_45_100_embrayage_pompe.text 
        app_data.pompe_principale_45_100_pression_HP = self.pompe_principale_45_100_pression_HP.text 
        app_data.pompe_principale_45_100_stand_by = self.pompe_principale_45_100_stand_by.text 
        app_data.pompe_principale_HPR165_38_verif_plein_huile = self.pompe_principale_HPR165_38_verif_plein_huile.text 
        app_data.pompe_principale_HPR165_38_sens_rotation = self.pompe_principale_HPR165_38_sens_rotation.text 
        app_data.pompe_principale_HPR165_38_embrayage_pompe = self.pompe_principale_HPR165_38_embrayage_pompe.text 
        app_data.pompe_principale_HPR165_38_pression_HP = self.pompe_principale_HPR165_38_pression_HP.text 
        app_data.pompe_principale_HPR165_38_stand_by = self.pompe_principale_HPR165_38_stand_by.text 
        app_data.groupe_secours_pompe_45_sens_rotation = self.groupe_secours_pompe_45_sens_rotation.text 
        app_data.groupe_secours_pompe_45_calage = self.groupe_secours_pompe_45_calage.text 
        app_data.groupe_secours_pompe_45_serrage = self.groupe_secours_pompe_45_serrage.text 
        app_data.groupe_secours_pompe_45_verif_plein_huile = self.groupe_secours_pompe_45_verif_plein_huile.text 
        app_data.groupe_secours_pompe_45_marche_arret_moteur = self.groupe_secours_pompe_45_marche_arret_moteur.text 
        app_data.groupe_secours_pompe_45_pression_HP = self.groupe_secours_pompe_45_pression_HP.text 
        app_data.groupe_secours_pompe_45_stand_by = self.groupe_secours_pompe_45_stand_by.text 
        app_data.groupe_secours_pompe_45_courant_demarrage = self.groupe_secours_pompe_45_courant_demarrage.text 
        app_data.groupe_secours_pompe_45_courant_service = self.groupe_secours_pompe_45_courant_service.text 
        app_data.reglage_limiteur_pression_REP10 = self.reglage_limiteur_pression_REP10.text 
        app_data.reglage_pressostat_retour = self.reglage_pressostat_retour.text 
        app_data.reglage_reducteur_pression_REP13 = self.reglage_reducteur_pression_REP13.text 
        app_data.reglage_reducteur_pression_grue_REP16 = self.reglage_reducteur_pression_grue_REP16.text 
        app_data.fonctionnement_sys_refrigeration_embrayage = self.fonctionnement_sys_refrigeration_embrayage.text
