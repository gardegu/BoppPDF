...
class ModifTreuils(Screen):
    """ 
    Classe du menu de modification treuils pour le BE
    """
    def __init__(self, **kwargs):
        """
        Visuel du menu de modification treuils
        """
        super(ModifTreuils, self).__init__(**kwargs)
        ...
        self.TPH125_0_traction_premiere_couche_statique = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.TPH125_0_traction_premiere_couche_dynamique = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH125_0_traction_premiere_couche_dynamique)

        layout.add_widget(Label(text="TPH125 0 pression :"))
        self.TPH125_0_pression = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH125_0_pression)

        layout.add_widget(Label(text="TPH125 0 vitesse rotation PV :"))
        self.TPH125_0_vitesse_rotation_PV = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH125_0_vitesse_rotation_PV)

        layout.add_widget(Label(text="TPH125 0 vitesse rotation GV :"))
        self.TPH125_0_vitesse_rotation_GV = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH125_0_vitesse_rotation_GV)

        layout.add_widget(Label(text="TPH125 0 debit :"))
        self.TPH125_0_debit = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH125_0_debit)

        layout.add_widget(Label(text="TPH125 0 essai file vire :"))
        self.TPH125_0_essai_file_vire = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH125_0_essai_file_vire)

        layout.add_widget(Label(text="TPH125 0 essai freinage :"))
        self.TPH125_0_essai_freinage = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH125_0_essai_freinage)

        layout.add_widget(Label(text="TPH125 0 selection PV GV :"))
        self.TPH125_0_selection_PV_GV = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH125_0_selection_PV_GV)

        layout.add_widget(Label(text="TPH50 0 traction premiere couche statique :"))
        self.TPH50_0_traction_premiere_couche_statique = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.TPH50_0_traction_premiere_couche_dynamique = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH50_0_traction_premiere_couche_dynamique)

        layout.add_widget(Label(text="TPH50 0 pression :"))
        self.TPH50_0_pression = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH50_0_pression)

        layout.add_widget(Label(text="TPH50 0 vitesse rotation PV :"))
        self.TPH50_0_vitesse_rotation_PV = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH50_0_vitesse_rotation_PV)

        layout.add_widget(Label(text="TPH50 0 vitesse rotation GV :"))
        self.TPH50_0_vitesse_rotation_GV = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH50_0_vitesse_rotation_GV)

        layout.add_widget(Label(text="TPH50 0 debit :"))
        self.TPH50_0_debit = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH50_0_debit)

        layout.add_widget(Label(text="TPH50 0 essai file vire :"))
        self.TPH50_0_essai_file_vire = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH50_0_essai_file_vire)

        layout.add_widget(Label(text="TPH50 0 essai freinage :"))
        self.TPH50_0_essai_freinage = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.TPH50_0_essai_freinage)

        layout.add_widget(Label(text="TPH50 0 selection PV GV :"))
        self.TPH50_0_selection_PV_GV = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
    ...
    def update(self):
        """ 
        Affiche les anciennes données dans les champs de texte
        """
        app_data = AppData()
        ...
        self.TPH125_0_traction_premiere_couche_statique.hint_text = app_data.data[
            "TPH125_0_traction_premiere_couche_statique"]
        self.TPH125_0_traction_premiere_couche_dynamique.hint_text = app_data.data[
            "TPH125_0_traction_premiere_couche_dynamique"]
        self.TPH125_0_pression.hint_text = app_data.data["TPH125_0_pression"]
        self.TPH125_0_vitesse_rotation_PV.hint_text = app_data.data["TPH125_0_vitesse_rotation_PV"]
        self.TPH125_0_vitesse_rotation_GV.hint_text = app_data.data["TPH125_0_vitesse_rotation_GV"]
        self.TPH125_0_debit.hint_text = app_data.data["TPH125_0_debit"]
        self.TPH125_0_essai_file_vire.hint_text = app_data.data["TPH125_0_essai_file_vire"]
        self.TPH125_0_essai_freinage.hint_text = app_data.data["TPH125_0_essai_freinage"]
        self.TPH125_0_selection_PV_GV.hint_text = app_data.data["TPH125_0_selection_PV_GV"]
        self.TPH50_0_traction_premiere_couche_statique.hint_text = app_data.data["TPH50_0_traction_premiere_couche_statique"]
        self.TPH50_0_traction_premiere_couche_dynamique.hint_text = app_data.data[
            "TPH50_0_traction_premiere_couche_dynamique"]
        self.TPH50_0_pression.hint_text = app_data.data["TPH50_0_pression"]
        self.TPH50_0_vitesse_rotation_PV.hint_text = app_data.data["TPH50_0_vitesse_rotation_PV"]
        self.TPH50_0_vitesse_rotation_GV.hint_text = app_data.data["TPH50_0_vitesse_rotation_GV"]
        self.TPH50_0_debit.hint_text = app_data.data["TPH50_0_debit"]
        self.TPH50_0_essai_file_vire.hint_text = app_data.data["TPH50_0_essai_file_vire"]
        self.TPH50_0_essai_freinage.hint_text = app_data.data["TPH50_0_essai_freinage"]
        self.TPH50_0_selection_PV_GV.hint_text = app_data.data["TPH50_0_selection_PV_GV"]
    ...
    def submit_form(self, instance):
        ...
        self.link_data()
        app_data = AppData()
        app_data.save_data_modif_treuil()
