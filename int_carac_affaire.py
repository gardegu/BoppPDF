...
class IntCaracAffaire(Screen):
    """ 
    Classe du menu de caractérisation de l'affaire pour les intervenants
    """
    def __init__(self,  **kwargs):
        """
        Visuel du menu de caractérisation de l'affaire pour les intervenants
        """
        super(IntCaracAffaire, self).__init__(**kwargs)
        ...
        self.case_number = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.case_number)

        # Nom du client
        layout.add_widget(Label(text="Nom du client :"))
        self.client_name = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.client_name)

        # Nom du bateau
        layout.add_widget(Label(text="Nom du bateau :"))
        self.boat_name = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.boat_name)

        # NB
        layout.add_widget(Label(text="NB :"))
        self.nb_field = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.nb_field)

        # Nom du chantier
        layout.add_widget(Label(text="Nom du chantier :"))
        self.site_name = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.site_name)

        # Armement
        layout.add_widget(Label(text="Armement :"))
        self.armement = TextInput(hint_text="Entrez l'armement", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.armement)

        # Bopp name
        layout.add_widget(Label(text="BOPP name :"))
        self.bopp_name = TextInput(hint_text="BOPP name", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.bopp_name)

        #Bopp date
        layout.add_widget(Label(text="BOPP date :"))
        self.bopp_date = TextInput(hint_text="BOPP date", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.bopp_date)

        #Bopp visa
        layout.add_widget(Label(text="BOPP visa :"))
        self.bopp_visa = TextInput(hint_text="BOPP visa", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.bopp_visa)

        # Chantier name
        layout.add_widget(Label(text="Chantier name :"))
        self.chantier_name = TextInput(hint_text="Chantier name", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.chantier_name)

        # Chantier date
        layout.add_widget(Label(text="Chantier date :"))
        self.chantier_date = TextInput(hint_text="Chantier date", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.chantier_date)

        # Chantier visa
        layout.add_widget(Label(text="Chantier visa :"))
        self.chantier_visa = TextInput(hint_text="Chantier visa", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.chantier_visa)

        # Armement name
        layout.add_widget(Label(text="Armement name :"))
        self.armement_name = TextInput(hint_text="Armement name", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.armement_name)

        # Armement date
        layout.add_widget(Label(text="Armement date :"))
        self.armement_date = TextInput(hint_text="Armement date", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.armement_date)

        # Armement visa
        layout.add_widget(Label(text="Armement visa :"))
        self.armement_visa = TextInput(hint_text="Armement visa", size_hint=(1, None), height=100, multiline=False, readonly=True)
        layout.add_widget(self.armement_visa)

        # Type d'intervention (liste déroulante)
        layout.add_widget(Label(text="Type d'intervention :"))
        self.intervention_type = TextInput(text="", size_hint=(1, None), height=100, multiline=False, readonly=True)
    ...
    def on_enter(self, *args):
        """
        Met à jour les données en affichant les données précédemment enregistrées
        Args:
          *args: arg de binding
    ...
    def link_data(self):
        """ 
        Met à jour les données de l'application en utilisant les données entrées par l'utilisateur
        """
        app_data = AppData()
