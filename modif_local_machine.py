...
class ModifLocalMachine(Screen):
    """ 
    Classe du menu de modification local machine pour le BE
    """
    def __init__(self, **kwargs):
        """
        Visuel du menu de modification local machine
        """
        super(ModifLocalMachine, self).__init__(**kwargs)
        ...
        self.schema_synoptique = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.schema_synoptique)

        layout.add_widget(Label(text="Schema electrique :"))
        self.schema_electrique = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.schema_electrique)

        layout.add_widget(Label(text="Schema de bornier :"))
        self.schema_bornier = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.schema_bornier)

        layout.add_widget(Label(text="Schema de cablage :"))
        self.schema_cablage = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.schema_cablage)

        layout.add_widget(Label(text="Relevés de rinçages des circuits :"))
        self.releves_rincages_circuits = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.releves_rincages_circuits)

        layout.add_widget(Label(text="AS Niveau Bas NB1 :"))
        self.as_niveau_bas_NB1 = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.as_niveau_bas_NB1)

        layout.add_widget(Label(text="AS Temperature Haute TH1 :"))
        self.as_temperature_haute_TH1 = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.as_temperature_haute_TH1)

        layout.add_widget(Label(text="AS Controle ARU :"))
        self.as_controle_ARU = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.as_controle_ARU)

        layout.add_widget(Label(text="AS Alarme Hydraulique Voyant Defaut :"))
        self.as_alarme_hydraulique_voyant_defaut = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.pompe_principale_45_100_verif_plein_huile = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.pompe_principale_45_100_sens_rotation = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.pompe_principale_45_100_embrayage_pompe = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.pompe_principale_45_100_pression_HP = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.pompe_principale_45_100_pression_HP)

        layout.add_widget(Label(text="Pompe Principale 45/100 - Stand-by :"))
        self.pompe_principale_45_100_stand_by = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.pompe_principale_HPR165_38_verif_plein_huile = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.pompe_principale_HPR165_38_sens_rotation = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.pompe_principale_HPR165_38_embrayage_pompe = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.pompe_principale_HPR165_38_pression_HP = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.pompe_principale_HPR165_38_stand_by = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.groupe_secours_pompe_45_sens_rotation = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.groupe_secours_pompe_45_sens_rotation)

        layout.add_widget(Label(text="Groupe Secours Pompe 45 - Calage :"))
        self.groupe_secours_pompe_45_calage = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.groupe_secours_pompe_45_calage)

        layout.add_widget(Label(text="Groupe Secours Pompe 45 - Serrage :"))
        self.groupe_secours_pompe_45_serrage = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.groupe_secours_pompe_45_verif_plein_huile = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.groupe_secours_pompe_45_marche_arret_moteur = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.groupe_secours_pompe_45_pression_HP = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.groupe_secours_pompe_45_pression_HP)

        layout.add_widget(Label(text="Groupe Secours Pompe 45 - Stand-by :"))
        self.groupe_secours_pompe_45_stand_by = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.groupe_secours_pompe_45_courant_demarrage = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.groupe_secours_pompe_45_courant_service = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.reglage_limiteur_pression_REP10 = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.reglage_limiteur_pression_REP10)

        layout.add_widget(Label(text="Réglage Pressostat Retour :"))
        self.reglage_pressostat_retour = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        layout.add_widget(self.reglage_pressostat_retour)

        layout.add_widget(Label(text="Réglage Réducteur Pression REP13 :"))
        self.reglage_reducteur_pression_REP13 = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.reglage_reducteur_pression_grue_REP16 = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
        ...
        self.fonctionnement_sys_refrigeration_embrayage = TextInput(hint_text="", size_hint=(1, None), height=100, multiline=False)
    ...
    def update(self):
        ...
        self.schema_synoptique.hint_text = app_data.data["Lm_schema_synoptique"]
        self.schema_electrique.hint_text = app_data.data["Lm_schema_electrique"]
        self.schema_bornier.hint_text = app_data.data["Lm_schema_bornier"]
        self.schema_cablage.hint_text = app_data.data["Lm_schema_cablage"]
        self.releves_rincages_circuits.hint_text = app_data.data["Lm_releves_rincages_circuits"]
        self.as_niveau_bas_NB1.hint_text = app_data.data["Lm_as_niveau_bas_NB1"]
        self.as_temperature_haute_TH1.hint_text = app_data.data["Lm_as_temperature_haute_TH1"]
        self.as_controle_ARU.hint_text = app_data.data["Lm_as_controle_ARU"]
        self.as_alarme_hydraulique_voyant_defaut.hint_text = app_data.data["Lm_as_alarme_hydraulique_voyant_defaut"]
        self.pompe_principale_45_100_verif_plein_huile.hint_text = app_data.data["Lm_pompe_principale_45_100_verif_plein_huile"]
        self.pompe_principale_45_100_sens_rotation.hint_text = app_data.data["Lm_pompe_principale_45_100_sens_rotation"]
        self.pompe_principale_45_100_embrayage_pompe.hint_text = app_data.data["Lm_pompe_principale_45_100_embrayage_pompe"]
        self.pompe_principale_45_100_pression_HP.hint_text = app_data.data["Lm_pompe_principale_45_100_pression_HP"]
        self.pompe_principale_45_100_stand_by.hint_text = app_data.data["Lm_pompe_principale_45_100_stand_by"]
        self.pompe_principale_HPR165_38_verif_plein_huile.hint_text = app_data.data[
            "Lm_pompe_principale_HPR165_38_verif_plein_huile"]
        self.pompe_principale_HPR165_38_sens_rotation.hint_text = app_data.data["Lm_pompe_principale_HPR165_38_sens_rotation"]
        self.pompe_principale_HPR165_38_embrayage_pompe.hint_text = app_data.data[
            "Lm_pompe_principale_HPR165_38_embrayage_pompe"]
        self.pompe_principale_HPR165_38_pression_HP.hint_text = app_data.data["Lm_pompe_principale_HPR165_38_pression_HP"]
        self.pompe_principale_HPR165_38_stand_by.hint_text = app_data.data["Lm_pompe_principale_HPR165_38_stand_by"]
        self.groupe_secours_pompe_45_sens_rotation.hint_text = app_data.data["Lm_groupe_secours_pompe_45_sens_rotation"]
        self.groupe_secours_pompe_45_calage.hint_text = app_data.data["Lm_groupe_secours_pompe_45_calage"]
        self.groupe_secours_pompe_45_serrage.hint_text = app_data.data["Lm_groupe_secours_pompe_45_serrage"]
        self.groupe_secours_pompe_45_verif_plein_huile.hint_text = app_data.data["Lm_groupe_secours_pompe_45_verif_plein_huile"]
        self.groupe_secours_pompe_45_marche_arret_moteur.hint_text = app_data.data[
            "Lm_groupe_secours_pompe_45_marche_arret_moteur"]
        self.groupe_secours_pompe_45_pression_HP.hint_text = app_data.data["Lm_groupe_secours_pompe_45_pression_HP"]
        self.groupe_secours_pompe_45_stand_by.hint_text = app_data.data["Lm_groupe_secours_pompe_45_stand_by"]
        self.groupe_secours_pompe_45_courant_demarrage.hint_text = app_data.data["Lm_groupe_secours_pompe_45_courant_demarrage"]
        self.groupe_secours_pompe_45_courant_service.hint_text = app_data.data["Lm_groupe_secours_pompe_45_courant_service"]
        self.reglage_limiteur_pression_REP10.hint_text = app_data.data["Lm_reglage_limiteur_pression_REP10"]
        self.reglage_pressostat_retour.hint_text = app_data.data["Lm_reglage_pressostat_retour"]
        self.reglage_reducteur_pression_REP13.hint_text = app_data.data["Lm_reglage_reducteur_pression_REP13"]
        self.reglage_reducteur_pression_grue_REP16.hint_text = app_data.data["Lm_reglage_reducteur_pression_grue_REP16"]
        self.fonctionnement_sys_refrigeration_embrayage.hint_text = app_data.data[
            "Lm_fonctionnement_sys_refrigeration_embrayage"]
        
    def on_enter(self, *args):
        """
        Met à jour les données affichées à chaque entrée dans l'écran
        Args:
          *args: arg de binding
    ...
    def link_data(self):
        """ 
        Met à jour les données avec les données entrées par l'utilisateur
        """
        app_data = AppData()
    ...
    def submit_form(self, instance):   
        ...
        self.link_data()   
        app_data = AppData()
        app_data.save_data_mofid_local_machine()
